...
void loadTexture()				
{
    ...
    // tex coords for sides: (0, 0) -> (1, 87/256)
    // tex coords for roof: (0, 115/256) -> (1, 212/256)
}
...
void wagon()
{
	...
	glBegin(GL_QUADS);
      ...
      glTexCoord2f(0.0, 0.0);	  glVertex3f(-35.0, 5.0, 6.0);
      glTexCoord2f(1.0, 0.0);	  glVertex3f(35.0, 5.0, 6.0);
      glTexCoord2f(1.0, 87./256.); 	  glVertex3f(35.0, 17.0, 6.0);
      glTexCoord2f(0.0, 87./256.); 	  glVertex3f(-35.0, 17.0, 6.0);
      ...
      glTexCoord2f(0, 114./256.);       glVertex3f(-35.0, 17.0, 6.0);
      glTexCoord2f(1, 114./256.);       glVertex3f(35.0, 17.0,  6.0);
      glTexCoord2f(1, 212./256.);       glVertex3f(35.0, 17.0, -6.0);
      glTexCoord2f(0, 212./256.);       glVertex3f(-35.0, 17.0, -6.0);
	glEnd();
